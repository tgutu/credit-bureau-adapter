...
func (x *GetBureausResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_cba_v1_credit_bureau_adapter_proto_rawDesc = "" +
	...
	"\x0eGetCreditScore\x12\x1d.cba.v1.GetCreditScoreRequest\x1a\x1e.cba.v1.GetCreditScoreResponse\".\xbaG\x10*\x0eGetCreditScore\x82\xd3\xe4\x93\x02\x15:\x01*\"\x10/v1/credit/scoreB\xc6\x01\xbaGW\x12\"\n" +
	"\x19Credit Bureau Adapter API2\x051.0.0\x1a1\n" +
	"\x15http://localhost:8080\x12\x18Local development server\n" +
	"\n" +
